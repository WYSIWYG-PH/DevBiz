// `tag` is optional — drop it to remove the small accent label next to a title.
const services = [
  {
    icon: 'ph-desktop',
  ...
  },
  {
    ...
    description: 'High-quality mobile applications tailored to your business needs.'
  },
  {
    icon: 'ph-code',
