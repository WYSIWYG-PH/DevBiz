const projects = [
  ...
  },
  {
    title: "Uni Lux",
    description:
      "A promotional landing page for a luxury bag business based in Metro Manila.",
  ...
  },
  {
    ...
    description:
      "A promotional landing page for an events and catering business in Davao City.",
  ...
  },
  {
    ...
    description:
      "A website for a cake shop that lets customers browse handcrafted cakes and place orders.",
  ...
  },
  {
    title: "Chade Inanag",
    description:
      "A promotional site for a Pinoy inihaw and unli-rice food business. Masarap, barato, sulit kaayo.",
